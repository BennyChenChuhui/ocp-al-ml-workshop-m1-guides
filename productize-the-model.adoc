...
image::images/che-login.png[che-login]
...
image::images/che-workspace.png[che-workspace]
...
image::images/che-terminal.png[che-terminal]
...
image::images/start-stop-codeready-workspaces.png[start-stop-codeready-workspaces]
...
image::images/codeready-file-explorer.png[codeready-file-explorer]

[NOTE]
====
You can ignore the pylint warning

image::images/che-pylint.png[che-pylint]
====
...
image::images/che-exposed-route.png[che-exposed-route]
====
