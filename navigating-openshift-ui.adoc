...
image::images/openshift-ui-login.png[openshift_ui_login]

== Creating a New Project

Proceed to create a new project with the name `{{  USER_ID }}-myproject` by selecting `Create Project`.

image::images/openshift-create-new-project.png[openshift_create_new_project]
...
image::images/openshift-project-list.png[openshift_project_list]
...
image::images/myproject-overview-page.png[myproject_overview_page]
...
image::images/openshift-developer-view.png[openshift_developer_view]
...
image::images/openshift-developer-catalog.png[openshift_developer_catalog]
...
image::images/developer-catalog-python.png[developer_catalog_python]

This will bring up a dialog with the details of the builder image. Click
on `Create Application` in the dialog.

image::images/python-s2i-create-app.png[python_s2i_create_app]
...
image::images/django-git-repo-url.png[django_git_repo_url]
...
image::images/django-application-settings.png[django_application_settings]
...
image::images/django-application-topology-view.png[django_application_topology_view]
...
image::images/django-image-build.png[django_image_build]

image::images/django-image-build-logs.png[django_image_build_logs]

Once the build of the application image has completed, it will be
deployed.

image::images/django-app-deployment.png[django_app_deployment]
...
image::images/django-app-deployed.png[django_app_deployed]

Clicking on the URL link will bring us to the Django application that
was just deployed.

image::images/django-app-webpage.png[django_app_webpage]
...
image::images/openshift-administrator-view.png[openshift_administrator_view]
...
image::images/django-pods.png[django_pods]
...
image::images/django-services.png[django_services]
...
image::images/django-routes.png[django_routes]
...
image::images/django-deployment-configs.png[django_deployment_configs]

image::images/django-deployment-configs-yaml.png[django_deployment_configs_yaml]
...
image::images/django-replication-controllers.png[django_replication_controllers]

image::images/django-replication-controllers-overview.png[django_replication_controllers_overview]
...
image::images/django-secrets.png[django_secrets]
...
image::images/django-configmaps.png[django_configmaps]
...
image::images/openshift-pv-pvc-sample.png[openshift_pv_pvc_sample]
