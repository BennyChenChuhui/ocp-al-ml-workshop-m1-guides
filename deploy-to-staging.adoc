...
Under /projects/{{USER_MODEL_REPO_NAME}}/src/train/config.sh:
...
image::images/buildah.png[buildah, 700]
...
image::images/seldon-inf-graph.png[seldon-inf-graph]
...
image::images/gogs-staging-branch.png[gogs-staging-branch, 300]
...
image::images/pipeline-openshift-ui.png[pipeline-openshift-ui]
...
image::images/docker-registry.png[docker-registry]
...
image::images/argocd-deploy.png[argocd-deploy]
...
image::images/seldon-deploy.png[seldon-deploy]
...
image::images/seldon-svc-orch.png[seldon-svc-orch]
