...
image::images/grafana-home.png[grafana-home, 200]

image::images/grafana-dashboard.png[grafana-dashboard, 700]
...
image::images/grafana-dropdown.png[grafana-dropdown, 500]
...
image::images/grafana-recall.png[grafana-recall, 400]
